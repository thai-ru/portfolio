...
tags: ['tech', 'apple']
draft: false
summary: With WWDC 2024 approaching, anticipation is high for the next wave of iPhone, iPad, Mac, Apple TV, HomePod, and Apple Watch advancements. Here are some features rumored or considered likely to make an appearance:
---

<img className="inline" src="/static/images/Blog/wwdc-2022-hero.jpeg" alt="WWDC 2024" />
...
- Sideloading apps.
  ...
  - I doubt Apple would ever implement this by their own choice; they would have to be legally forced by the [Open App Markets Act](npmhttps://en.wikipedia.org/wiki/Open_App_Markets_Act), the [Digital Markets Act](https://en.wikipedia.org/wiki/Digital_Markets_Act), or a similar bill.
